...
_lr_productions = [
  ...
  ('statement -> NAME = expression','statement',3,'p_statement_assign','grammars.py',15),
  ('statement -> expression','statement',1,'p_statement_expr','grammars.py',19),
  ('expression -> expression + expression','expression',3,'p_expression_binop','grammars.py',23),
