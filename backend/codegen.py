...
class CodeGenerator(object):
    ...
    def _codegen_ConstValueNode(self,node,builder):
        return ir.Constant(self._helper_get_type(node.type),node.value)
    ...
    def _codegen_ArrayMemberNode(self,node,builder):
        ...
        for i in node.indices:
            ...
            index.append(val)
        indices=index
        # indices=[ir.Constant(ir.IntType(32),index),ir.Constant(ir.IntType(32),0)]
        indices.append(ir.Constant(ir.IntType(32),0))
    ...
    def _codegen_IfExpr(self,node,builder):
        ...
        cmp_res=builder.icmp_signed('!=',cond_val,ir.Constant(ir.IntType(1),0))
    ...
    def _codegen_WhileExpr(self,node,builder):
        ...
        cmp_res=builder.icmp_signed('!=',end_expr_val,ir.Constant(ir.IntType(1),0))
